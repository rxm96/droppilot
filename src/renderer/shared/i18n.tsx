...
const translations: Translations = {
  en: {
    ...
    "settings.row.refreshInterval.label": "Inventory refresh interval",
    "settings.row.refreshInterval.description":
      "How often DropPilot re-queries your Drops inventory from Twitch (random jitter between min and max).",
  ...
  de: {
    ...
    "settings.row.refreshInterval.label": "Inventory-Refresh-Intervall",
    "settings.row.refreshInterval.description":
      "Wie oft DropPilot dein Drops-Inventar bei Twitch neu abfragt (zufälliger Jitter zwischen Min und Max).",
