...
const translations: Translations = {
  en: {
    ...
    "settings.refreshHint": "Bounds for periodic inventory refresh (seconds, min 3600s).",
  ...
  de: {
    ...
    "settings.refreshHint": "Grenzen für periodischen Inventory-Refresh (Sekunden, min 3600s).",
